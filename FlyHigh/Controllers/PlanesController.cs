...
namespace FlyHigh.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public PlanesController(FlyHighContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PlaneId,Name,Model,NumberOfSeats")] Plane plane)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var plane = await _context.Plane.SingleOrDefaultAsync(m => m.PlaneId == id);
            if (plane == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlaneId,Name,Model,NumberOfSeats")] Plane plane)
        {
            if (id != plane.PlaneId)
            {
                return NotFound();

...
namespace FlyHigh.Controllers
{
    public class SeatsController : Controller
    {
        ...
        public SeatsController(FlyHighContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var seat = await _context.Seat.SingleOrDefaultAsync(m => m.SeatId == id);
            if (seat == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SeatId")] Seat seat)
        {
            if (id != seat.SeatId)
            {
                return NotFound();
